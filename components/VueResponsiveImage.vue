<template>
  <picture>
    ...
    <img :src="defaultImage" :alt="alt" :class="[defaultClass, imageClass]" :srcset="srcset" :sizes="sizes" @load="$emit('load')">
  </picture>
</template>

<script>
//copied from https://github.com/HCESrl/vue-responsive-image/blob/master/src/ResponsiveImage.vue
// we just add @load event
